...
using TCSS_WindowsApp.Behaviors;
using TCSS_WindowsApp.Services.Ink;
...
namespace TCSS_WindowsApp.Views
{
    ...
    public sealed partial class WorkplansPage : Page
    {
        public WorkplansViewModel ViewModel { get; } = new WorkplansViewModel();

        public WorkplansPage()
        {
            InitializeComponent();
